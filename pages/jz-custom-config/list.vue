<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="jz-custom-config" field="config_bm,config_zw,config_val,config_describe" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            <uni-td align="center">{{item.config_bm}}</uni-td>
            <uni-td align="center">{{item.config_zw}}</uni-td>
            <uni-td align="center">{{item.config_val}}</uni-td>
            <uni-td align="center">{{item.config_describe}}</uni-td>
            <uni-td align="center">
              <view class="uni-group">
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/jz-custom-config.js';
