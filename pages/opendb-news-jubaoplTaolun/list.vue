<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="article_id,comment_id,jubao_content" :where="where" page-data="replace"
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/opendb-news-jubaoplTaolun.js';
  ...
  export default {
    data() {
      return {
        collectionList: "opendb-news-jubaoplTaolun",
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
        ...
        exportExcel: {
          "filename": "opendb-news-jubaoplTaolun.xls",
          "type": "xls",
          "fields": {
            "文章ID": "article_id",
