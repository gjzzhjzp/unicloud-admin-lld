	...
	<view class="fix-top-window">
		<view class="uni-header">
			...
			<view class="uni-group">
				...
				<button class="uni-button" type="default" size="mini" @click="ceratedYqm">批量生成邀请码</button>
				<!-- #ifdef H5 -->
			...
			<unicloud-db ref="udb" collection="uni-id-users,uni-id-roles"
				...
				<uni-table ref="table" :loading="loading" :emptyText="error.message || $t('common.empty')" border stripe
					...
					<uni-tr>
						...
						<uni-th align="center" width="100" filter-type="select"
							:filter-data="options.filterData.isbdwb_localdata"
	...
	export default {
		...
		methods: {
			...
			async ceratedYqm() {
				...
				var userlist = await db.collection("uni-id-users").where(
					"weiboname!=''&&weiboname!=null&&isbdwb==true").limit(10000).get();
