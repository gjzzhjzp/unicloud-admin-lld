...
<script>
  import { validator } from '../../js_sdk/validator/opendb-news-jubaopl.js';

  const db = uniCloud.database();
  const dbCmd = db.command;
  const dbCollectionName = 'opendb-news-jubaopl';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("article_id,comment_id,jubao_content").get().then((res) => {
