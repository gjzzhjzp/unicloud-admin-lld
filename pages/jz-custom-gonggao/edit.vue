  ...
  <view class="uni-container">
    <uni-forms ref="form" :value="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="content" label="公告内容" required>
        <uni-easyinput type="textarea" autoHeight :maxlength="1000" placeholder="公告内容" v-model="formData.content"></uni-easyinput>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("number,content,status").get().then((res) => {
