  ...
  <view class="uni-container">
    <uni-forms ref="form" :value="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="options" label="选项" required>
        <uni-easyinput placeholder="选项" v-model="formData.options" trim="both"></uni-easyinput>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/jz-custom-gzquestion.js';

  const db = uniCloud.database();
  const dbCmd = db.command;
  const dbCollectionName = 'jz-custom-gzquestion';
