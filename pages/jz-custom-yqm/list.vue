<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="jz-custom-yqm,uni-id-users" field="user_type,user_name_type,user_name,date,value,status,user_id.nickname" :where="where" page-data="replace"
