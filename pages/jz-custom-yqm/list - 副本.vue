<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="jz-custom-yqm" field="user_name_type,user_type,user_name,value,status,date" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="select" :filter-data="options.filterData.user_type_localdata" @filter-change="filterChange($event, 'user_type')">使用状态</uni-th>
