<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="jz-custom-language" field="type,sort,content" :where="where" page-data="replace"
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/jz-custom-language.js';
  ...
  export default {
    data() {
      return {
        ...
        exportExcel: {
          "filename": "jz-custom-language.xls",
          "type": "xls",
          "fields": {
            "类型": "type",
            "排序": "sort",
