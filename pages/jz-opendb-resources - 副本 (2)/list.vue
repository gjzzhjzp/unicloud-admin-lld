<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="jz-opendb-resources" field="author,title,article_status,comment_status,avatar,resources,zy_gs,excerpt,content" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'zy_gs')" sortable @sort-change="sortChange($event, 'zy_gs')">资源格式</uni-th>
