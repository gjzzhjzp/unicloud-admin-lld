    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="opendb-news-rili" field="rili_date,rili_title,rili_images,rili_content" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            <uni-th width="180" align="center" filter-type="search" @filter-change="filterChange($event, 'rili_date')" sortable @sort-change="sortChange($event, 'rili_date')">日期</uni-th>
            <uni-th width="250" align="center" filter-type="search" @filter-change="filterChange($event, 'rili_title')" sortable @sort-change="sortChange($event, 'rili_title')">标题</uni-th>
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            <uni-td width="200px" align="center">{{item.rili_date}}</uni-td>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/opendb-news-rili.js';
