<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="article_id,comment_content,like_count,comment_type,reply_user_id,reply_comment_id,all_reply_comment_id,comment_cj" :where="where" page-data="replace"
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/opendb-news-commentsTaolun.js';
  ...
  export default {
    data() {
      return {
        collectionList: "opendb-news-commentsTaolun",
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
        ...
        exportExcel: {
          "filename": "opendb-news-commentsTaolun.xls",
          "type": "xls",
          "fields": {
            "文章ID": "article_id",
