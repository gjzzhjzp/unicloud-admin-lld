<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="opendb-banner" field="bannerfile,open_url,title,sort,category_id,status,description" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'category_id')" sortable @sort-change="sortChange($event, 'category_id')">分类id</uni-th>
