<template>
	<view ref="node"
		...
		<view class="ly-tree-node__content" 
			...
			<view>
				<text>【</text>
				<text @tap.stop="handleExtButtonClick('del')" class="ly-tree-node__extbutton" >删除</text>
				<text>】</text>
			</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			,handleExtButtonClick(e) {
				...
				this.tree.currentNode = this.node;
				var senddata = this.node
				senddata.buttonvalue=e
				this.tree.$emit('node-extbutton-click', senddata);
			}
		},
